[![Travis-CI Build Status](https://travis-ci.org/rte-antares-rpackage/antaresXpansion.svg?branch=master)](https://travis-ci.org/rte-antares-rpackage/antaresXpansion)
